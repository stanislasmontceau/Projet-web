...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT cin, nom,nom_restaurant,type,description FROM restaurant WHERE nom LIKE ? OR type LIKE ?"); /*si on veut rajouter des attributs à la recherche, ici ils ne cherchera que dans nom et type, si on veut tous, il faut rajouter "WHERE attributs LIKE ? etc*/
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Stan</span>
          ...
          <div class="card shadow mb-4">
              ...
              while($terme_trouve = $select_terme->fetch())
              {
                  ?>  
                      ...
                      <td><?PHP echo $terme_trouve['nom_restaurant']; ?></td>
                  ...
                  <td><a href="modifierRestaurant.php?cin=<?PHP echo $terme_trouve['cin']; ?>">
                  Modifier</a></td>
                      </tr>
                          <?PHP
                        }
