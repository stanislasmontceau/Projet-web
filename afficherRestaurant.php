...
if (isset($_POST['modifier'])){
 ...
 $restaurant=new restaurant($_POST['cin'],$_POST['nom'],$_POST['nom_restaurant'],$_POST['type'],$_POST['description']);
 $restaurantC=new RestaurantC();
 $restaurantC->modifierRestaurant($restaurant,$_POST['cin_ini']);

  //header('Location: ajoutRestaurant.php');

  
}
$restaurant1C=new RestaurantC();
$listeRestaurants=$restaurant1C->afficherRestaurants();

//var_dump($listeRestaurants->fetchAll());
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Stan</span> <!-- remplacer par admin -->
                <img class="img-profile rounded-circle" src="img/photo stanislas montceau">
              </a>
      ...
      <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">Restaurants</h4>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                  <div class="search-content">
                                       ...
                                       <input  type = "submit" class="btn btn-info btn-icon-split" name = "s" value="Rechercher">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?PHP
              foreach($listeRestaurants as $row){
                ?>
                <tr>
                  ...
                  <td><form method="POST" action="supprimerRestaurant.php">
                  <input type="submit" class="btn btn-danger btn-icon-split" name="supprimer" value="supprimer">
                  <input type="hidden" value="<?PHP echo $row['cin']; ?>" name="cin">
                  </form>
                  </td>
                  <td><a href="modifierRestaurant.php?cin=<?PHP echo $row['cin']; ?>">
                  Modifier</a></td>
                </tr>
                <?PHP
              }
        ...
        <!-- /.container-fluid -->
        	<br><br><br>
        	<td><a href="imprimer2.php">
            Convertir cette page en pdf</a></td>
