    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">Envoyer Newsletter</h4>
            </div>
            <div class="card-body">
...
<?php
 ...
 require 'PHPMailer/SMTP.php';
  if (!$_POST) {
    ...
    <p><label for="message">Corps du mail:</label><br/>
     <textarea id="message" name="message" cols="50"   rows="10"></textarea></p>
     <button type="submit" class="btn btn-success btn-icon-split" name="submit" value="submit">Submit</button>
     </form>
END_OF_BLOCK;
 } else if ($_POST) {
