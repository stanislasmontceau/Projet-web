...
if (isset($_GET['cin'])){
  $restaurantC=new RestaurantC();
    $result=$restaurantC->recupererRestaurant($_GET['cin']);
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form method="POST" action="afficherRestaurant.php">
            ...
            <td><input type="text" name="nom_restaurant" value="<?PHP echo $nom_restaurant ?>"></td>
            </tr>
            <tr>
            <td>Type</td>
            ...
            <a class="collapse-item active" href="afficherRestaurant.php">Modifier</a>
