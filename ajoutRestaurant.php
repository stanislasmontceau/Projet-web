      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Restaurant</h1>
           ...
           <form method="POST" action="ajoutRestaurant.php">       <!--changer le nom de ajoutEmploye.php par ajoutRestaurant.php -->
              ...
              <td><input type="text" name="nom_restaurant"></td>
